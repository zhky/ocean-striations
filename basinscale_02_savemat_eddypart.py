...
for s in range(1,6):
    ...
    eta_files = sorted(glob.glob('./s1' + str(s) + "/output/snap.eta.*"))
    h_files =   sorted(glob.glob('./s1' + str(s) + "/output/snap.h.*"))
    ...
    dataNew1 = './s1' + str(s) + '/output_v_eddy.mat'
    dataNew2 = './s1' + str(s) + '/output_u_eddy.mat'
    dataNew3 = './s1' + str(s) + '/output_eta_eddy.mat'
    dataNew4 = './s1' + str(s) + '/output_h_eddy.mat'
