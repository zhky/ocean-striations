...
for s in range(1,7):
    for t in range(len(yt)-1):
        ...
        dataNew1 = './s1' + str(s) + '/output_v_mean_' + str(y1*2+1) + '-' + str(y2*2) + '.mat'
        dataNew2 = './s1' + str(s) + '/output_u_mean_' +  str(y1*2+1) + '-' + str(y2*2) + '.mat'
        dataNew3 = './s1' + str(s) + '/output_eta_mean_' +  str(y1*2+1) + '-' + str(y2*2) + '.mat'
        dataNew4 = './s1' + str(s) + '/output_h_mean_' +  str(y1*2+1) + '-' + str(y2*2) + '.mat'
