...
%     caxis([0 1000])
    ...
    if j == 1
        title('2D psd of u_0 in GM','fontsize',12,'fontweight','bold');
    elseif j == 2
        title('2D psd of u_0 in NA','fontsize',12,'fontweight','bold');
    end
...
%     caxis([0 200])
    cmocean('matter',20);colorbar;
    if j == 1
        title('2D psd of u_{str} on {\lambda} = 400 km in GM','fontsize',12,'fontweight','bold');
    elseif j == 2
        title('2D psd of u_{str} on {\lambda} = 400 km in NA','fontsize',12,'fontweight','bold');
    end
    ylabel('L in meridional (km)','fontweight','bold');
    set(gca,'tickdir','out','fontsize',12);
...
%     caxis([0 10])
    cmocean('matter',20);colorbar;
    if j == 1
        title('2D psd of u_{str} on {\lambda} = 200 km in GM','fontsize',12,'fontweight','bold');
    elseif j == 2
        title('2D psd of u_{str} on {\lambda} = 200 km in NA','fontsize',12,'fontweight','bold');
    end
