...
if __name__ == '__main__':
    ...
    #wind_asymmetric_steady(2880e3,3840e3, 97,129,105*360*24*3,1200,4.e-8,'s01')
    #wind_asymmetric_steady(3840e3,3840e3,129,129,105*360*24*3,1200,4.e-8,'s02')
    #wind_asymmetric_steady(5760e3,3840e3,193,129,105*360*24*3,1200,4.e-8,'s03')
    #wind_asymmetric_steady(7680e3,3840e3,257,129,105*360*24*3,1200,4.e-8,'s04')
    
    wind_asymmetric_steady(2880e3,3840e3, 97,129,150*360*24*3,1200,4.e-8,'s05')
    wind_asymmetric_steady(3840e3,3840e3,129,129,150*360*24*3,1200,4.e-8,'s06')
    wind_asymmetric_steady(5760e3,3840e3,193,129,150*360*24*3,1200,4.e-8,'s07')
    wind_asymmetric_steady(7680e3,3840e3,257,129,150*360*24*3,1200,4.e-8,'s08')
