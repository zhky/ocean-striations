...
if __name__ == '__main__':
    ...
    #wind_asymmetric_steady(3840e3,3840e3,128,128,150*360*24*4,900,4.e-8,'s21')
    wind_asymmetric_steady(3840e3,3840e3,192,192,150*360*24*4,900,4.e-8,'s22')
    #wind_asymmetric_steady(3840e3,3840e3,256,256,150*360*24*6,600,4.e-8,'s23')
    #wind_asymmetric_steady(3840e3,3840e3,384,384,150*360*24*6,600,4.e-8,'s24')
